    ...
    <ul class="nav nav-link-secondary flex-column fw-bold gap-2">
        ...
        <li>
            ...
            <div id="transaksi-submenu" class="collapse">
                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <!-- <li class="nav-item">
                        <a href="{{ ('service_transactions.index') }}" class="{{ Request::is('service_transactions*') ? 'text-white bg-custom rounded active' : '' }} nav-link ps-4">
                            Servis
                        </a>
                    </li> -->
                    <!-- <li class="nav-item">
                        <a href="{{ ('sparepart') }}" class="{{ Request::is('sparepart') ? 'text-white bg-custom rounded active' : '' }} nav-link ps-4">
                            Sparepart
                        </a>
                    </li> -->
                </ul>
        ...
        <li>
            ...
            <!-- <div id="database-submenu" class="collapse">
                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><a href="{{ ('users.index') }}" class="{{ Request::is('users*') ? 'text-white bg-custom rounded active' : '' }} nav-link ps-4">Teknisi</a></li>
                    <li><a href="{{ ('customers.index') }}" class="{{ Request::is('customers*') ? 'text-white bg-custom rounded active' : '' }} nav-link ps-4">Pelanggan</a></li>
                    <li><a href="{{ ('laptops.index') }}" class="{{ Request::is('laptops*') ? 'text-white bg-custom rounded active' : '' }} nav-link ps-4">Laptop</a></li>
                    <li><a href="{{ ('services.index') }}" class="{{ Request::is('services*') ? 'text-white bg-custom rounded active' : '' }} nav-link ps-4">Jasa Servis</a></li>
                </ul>
            </div> -->
        </li>
        <li>
